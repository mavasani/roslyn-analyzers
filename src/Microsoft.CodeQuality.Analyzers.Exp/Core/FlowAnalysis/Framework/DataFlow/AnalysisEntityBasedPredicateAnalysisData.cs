...
namespace Microsoft.CodeAnalysis.Operations.DataFlow
{
    internal abstract class AnalysisEntityBasedPredicateAnalysisData<TValue> : PredicatedAnalysisData<AnalysisEntity, TValue>
    {
        ...
        protected AnalysisEntityBasedPredicateAnalysisData(IDictionary<AnalysisEntity, TValue> fromCoreAnalysisData)
        {
            CoreAnalysisData = new Dictionary<AnalysisEntity, TValue>(fromCoreAnalysisData);
        }
        ...
        protected AnalysisEntityBasedPredicateAnalysisData(
            ...
            : base(data1, data2, data1.CoreAnalysisData, data2.CoreAnalysisData, coreDataAnalysisDomain)
        {
        ...
        protected AnalysisEntityBasedPredicateAnalysisData(
            ...
            MapAbstractDomain<AnalysisEntity, TValue> coreDataAnalysisDomain)
            : base(predicatedData1, predicatedData2, mergedCoreAnalysisData, mergedCoreAnalysisData, coreDataAnalysisDomain)
        {
