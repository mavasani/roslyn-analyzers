...
namespace Microsoft.CodeAnalysis.Operations.DataFlow.PointsToAnalysis
{
    ...
    internal partial class PointsToAnalysis : ForwardDataFlowAnalysis<PointsToAnalysisData, PointsToBlockAnalysisResult, PointsToAbstractValue>
    {
            ...
            bool pessimisticAnalysis = true)
        {
            ...
            return pointsToAnalysis.GetOrComputeResultCore(cfg, rootOperation, cacheResult: true, seedResultOpt: pointsToAnalysisResultOpt);
        }
        ...
        protected override PointsToAnalysisData GetInputData(PointsToBlockAnalysisResult result) => new PointsToAnalysisData(result.InputData);
    }
}
