...
namespace Analyzer.Utilities.FlowAnalysis.Analysis.TaintedDataAnalysis
{
    ...
    {
        /// <summary>
        /// Unique ID for <see cref="TaintedDataConfig"/> cache.
        /// </summary>
        private static readonly object s_taintedDataConfigCacheId = new object();
...
#pragma warning restore CA1721 // Property names should not match get methods
        ...
        /// <summary>
        /// Gets a cached <see cref="TaintedDataConfig"/>.
        /// </summary>
        /// <returns>The TaintedDataConfig.</returns>
        public static TaintedDataConfig GetOrCreate(CompilationDataProvider compilationDataProvider)
        {
            return compilationDataProvider.GetOrCreateValue(CreateTaintedDataConfig, s_taintedDataConfigCacheId);

            // Local functions
            TaintedDataConfig CreateTaintedDataConfig(Compilation _)
                => Create(compilationDataProvider);
        }
        ...
        private static TaintedDataConfig Create(CompilationDataProvider compilationDataProvider)
        {
