...
//            var context = new TestCompilationStartAnalysisContext(compilation, options);
//            var compilationDataProvider = CompilationDataProviderFactory.CreateProvider(context);

//            ISymbol symbol = model.GetDeclaredSymbol(syntaxNode.Parent) ?? model.GetSymbolInfo(syntaxNode.Parent).Symbol;
//            var success = operation.TryGetEnclosingControlFlowGraph(compilationDataProvider, out var cfg);
...
//        #region TestCompilationStartAnalysisContext
//        private class TestCompilationStartAnalysisContext : CompilationStartAnalysisContext
//        {
//            public TestCompilationStartAnalysisContext(Compilation compilation, AnalyzerOptions options)
